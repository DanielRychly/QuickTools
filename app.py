...
def name_extractor():
    return render_template('name_extractor.html')
...
def annotation_extractor():
    return render_template('annotation_extractor.html')
...
def process_pdfs():
    ...
    return render_template('process_pdfs.html', parsed_text=parsed_text)
